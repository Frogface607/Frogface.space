...
const SYSTEM_PROMPT = [
  ...
  "",
  "=== RPG СИСТЕМА ===",
  "Уровень Архитектора, XP, золото — всё живое и хранится в Supabase.",
  "При завершении квеста автоматически начисляется XP и может быть level up.",
  "Используй /report для утреннего отчёта со статами.",
].join("\n");
