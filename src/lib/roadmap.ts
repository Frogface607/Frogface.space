...
export const ROADMAP = {
  ...
  completedDay1: [
    "Frogface.space построен с нуля — дашборд, агенты, командный центр",
    "8 AI-агентов с персональными промптами и контекстом",
    "PWA + мобильная вёрстка + OpenRouter интеграция",
    "API endpoints для Custom GPT Actions",
